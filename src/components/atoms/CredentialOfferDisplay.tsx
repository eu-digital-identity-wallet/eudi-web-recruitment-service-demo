...
export default function CredentialOfferDisplay({
  offerUrl,
}: CredentialOfferDisplayProps) {
    ...
    <Card variant="outlined" sx={{ mt: 3 }}>
      <CardContent>
        <Alert severity="success" sx={{ mb: 3 }}>
          ...
          Your application receipt credential is ready. Scan the QR code or use
          the deep link to add it to your EUDI wallet.
        </Alert>
