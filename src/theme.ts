...
export const theme = createTheme({
	...
	components: {
		...
		MuiAppBar: {
			styleOverrides: {
				root: { backgroundColor: '#003680', boxShadow: 'none', borderBottom: '1px solid #dddddd' },
			},
		},
		MuiButton: {
			styleOverrides: {
		...
		MuiTypography: {
			styleOverrides: { h5: { fontSize: '1.3rem', fontWeight: 600, color: '#000' } },
		},
	},
});
