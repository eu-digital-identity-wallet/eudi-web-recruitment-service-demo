...
export default async function EmployeeCredentialPage({
  ...
  if (!existingCredential) {
    try {
      ...
      await issuerService.issueApplicationReceipt(app as typeof app & { job: NonNullable<typeof app.job> });
    ...
    <main>
      <Card variant="outlined">
        ...
        <CardContent sx={{ pt: 0, textAlign: "center", '&:last-child': { pb: 2 } }}>
          {existingCredential ? (
            ...
            >
              ...
              <Typography variant="body2">
                {issuerError || "There was an error generating your employee credential. This service requires registration with the EUDI issuer. Please contact the administrator or try again later."}
              </Typography>
            </Alert>
          )}
          ...
          {otp && (
            <Alert severity="info" sx={{ mt: 2, '& .MuiAlert-message': { width: '100%', textAlign: 'center' } }}>
